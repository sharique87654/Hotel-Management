    ...
    return (
        ...
        <div className="flex h-screen flex-col justify-between border-e bg-white float-left ml-10">
            ...
            <ul className="mt-6 space-y-4">
                ...
                <a
                    href="#"
                    className="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-200 text-blue-700"
                >
                    Account
                </a>
                </li>
                ...
                <a
                    href="#"
                    className="block rounded-lg px-4 py-2 text-sm font-medium text-gray-500 hover:bg-gray-200 text-red-700" onClick={onclick}
                >
                    Logout
                </a>
                </li>
